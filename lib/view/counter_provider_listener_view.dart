...
class CounterProviderListenerView extends ConsumerWidget {
  const CounterProviderListenerView({Key? key}) : super(key: key);
  static Route route() => MaterialPageRoute<void>(builder: (_) => CounterProviderListenerView());
  ...
  Widget build(BuildContext context, ScopedReader watch) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'CounterProviderListener | Counter App',
        ),
      ),
      body: ProviderListener<StateController<int>>(
